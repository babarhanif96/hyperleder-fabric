...
CHINCODE_NAME="pesticideLedgerContract"
...
echo
echo "Deploy smart contract Pesticide Ledger Network (PLN) fabric blockchain"
echo
...
echo
echo "========= Pesticide Ledger Network (PLN) contract successfully deployed on channel $CHANNEL_NAME  =========== "
