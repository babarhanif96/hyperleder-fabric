...
/**
 * Define PesticideLedger smart contract by extending Fabric Contract class
 *
 */
class PesticideLedgerContract extends Contract {

    constructor() {
        // Unique namespace pcn - PesticideChainNetwork when multiple contracts per chaincode file
        super('org.pln.PesticideLedgerContract');
    }
    /**
    ...
    async instantiate(ctx) {
        ...
        console.log('Instantiate the PesticideLedger contract');
    }

    /**
     * Create pesticide equipment
     *
     * @param {Context} ctx the transaction context
...
module.exports = PesticideLedgerContract;
